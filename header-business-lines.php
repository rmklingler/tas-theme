   	...
   	if( spacious_options( 'spacious_activate_slider', '0' ) == '1' ) {
		...
		if( ( '' != spacious_header_title() )  && !( is_front_page() ) ) {
			if( !( spacious_options( 'spacious_blog_slider', '0' ) != '1' && is_home( ) ) ){ ?>
				<div class="header-post-title-container clearfix" style="border-top-color: <?php echo get_post_meta( get_the_ID() , 'tas_border_hex', true ); ?>;">
					<div class="inner-wrap">
						<div class="post-title-wrapper clearfix">
                           ...
                           <h1 class="business-header header-post-title-class"><?php echo spacious_header_title(); ?></h1>
                           <h2 class="business-header header-post-title-class"><?php echo get_post_meta( get_the_ID() , 'tas_subtitle', true ); ?></h2>
						   <?php
							}
							?>
						</div>
